...
length(calcification[115:150,]$Cover) # = 36
...
# Phytoplankton - Macroalgal forests         -0.769 0.471 119  -1.631  0.1056 NS
# Phytoplankton - Seagrass meadows           -2.658 0.598 119  -4.445  <.0001 ***
# Phytoplankton - Mangrove forests           -2.778 0.576 119  -4.822  <.0001 ***
# Phytoplankton - Marshes                    -4.024 0.459 119  -8.766  <.0001 ***
# Phytoplankton - Grasslands                 -2.496 0.459 119  -5.437  <.0001 ***
# Phytoplankton - Terrestrial forests        -3.527 0.448 119  -7.864  <.0001 ***
# Macroalgal forests - Seagrass meadows      -1.889 0.615 119  -3.069  0.0027 **
# Macroalgal forests - Mangrove forests      -2.009 0.594 119  -3.381  0.0010 ***
# Macroalgal forests - Marshes               -3.255 0.482 119  -6.759  <.0001 ***
# Macroalgal forests - Grasslands            -1.727 0.482 119  -3.586  0.0005 ***
# Macroalgal forests - Terrestrial forests   -2.758 0.471 119  -5.849  <.0001 ***
# Seagrass meadows - Mangrove forests        -0.120 0.699 119  -0.172  0.8639 NS
# Seagrass meadows - Marshes                 -1.366 0.606 119  -2.254  0.0260 *
# Seagrass meadows - Grasslands               0.162 0.606 119   0.268  0.7894 NS
# Seagrass meadows - Terrestrial forests     -0.869 0.598 119  -1.453  0.1488 NS
# Mangrove forests - Marshes                 -1.246 0.584 119  -2.132  0.0350 *
# Mangrove forests - Grasslands               0.282 0.584 119   0.483  0.6300 NS
# Mangrove forests - Terrestrial forests     -0.749 0.576 119  -1.300  0.1961 NS
# Marshes - Grasslands                        1.528 0.469 119   3.256  0.0015 **
# Marshes - Terrestrial forests               0.497 0.459 119   1.083  0.2811 NS
# Grasslands - Terrestrial forests           -1.031 0.459 119  -2.246  0.0265 *
...
# contrast                                 estimate    SE  df z.ratio p.value
# Phytoplankton - Macroalgal forests        -1.3866 0.217 438  -6.396  <.0001 ***
# Phytoplankton - Seagrass meadows          -0.1292 0.209 438  -0.617  0.5374 NS
# Phytoplankton - Mangrove forests           0.4716 0.335 438   1.407  0.1601 NS
# Phytoplankton - Marshes                   -0.4154 0.279 438  -1.489  0.1372 NS
# Phytoplankton - Grasslands                 0.5563 0.236 438   2.353  0.0191 *
# Phytoplankton - Terrestrial forests        0.6352 0.211 438   3.016  0.0027 **
# Macroalgal forests - Seagrass meadows      1.2573 0.216 438   5.816  <.0001 ***
# Macroalgal forests - Mangrove forests      1.8582 0.339 438   5.474  <.0001 ***
# Macroalgal forests - Marshes               0.9712 0.284 438   3.418  0.0007 ***
# Macroalgal forests - Grasslands            1.9428 0.242 438   8.012  <.0001 ***
# Macroalgal forests - Terrestrial forests   2.0218 0.217 438   9.301  <.0001 ***
# Seagrass meadows - Mangrove forests        0.6009 0.335 438   1.795  0.0734 NS
# Seagrass meadows - Marshes                -0.2861 0.278 438  -1.027  0.3048 NS
# Seagrass meadows - Grasslands              0.6855 0.236 438   2.906  0.0038 **
# Seagrass meadows - Terrestrial forests     0.7645 0.210 438   3.640  0.0003 ***
# Mangrove forests - Marshes                -0.8870 0.382 438  -2.321  0.0207 *
# Mangrove forests - Grasslands              0.0846 0.352 438   0.240  0.8103 NS
# Mangrove forests - Terrestrial forests     0.1636 0.336 438   0.488  0.6261 NS
# Marshes - Grasslands                       0.9716 0.299 438   3.246  0.0013 **
# Marshes - Terrestrial forests              1.0506 0.279 438   3.760  0.0002 ***
# Grasslands - Terrestrial forests           0.0790 0.237 438   0.333  0.7392 NS
...
# Response: Carbon
#           LR Chisq Df Pr(>Chisq)    
# Ecosystem   37.981  6  1.133e-06 ***
  
emmeans(m13, pairwise ~ "Ecosystem", adjust = "none")$contrasts
# contrast                                 estimate    SE  df z.ratio p.value
# Phytoplankton - Macroalgal forests        -1.7650 0.478 117  -3.692  0.0003 ***
# Phytoplankton - Seagrass meadows          -0.9503 0.542 117  -1.754  0.0820 NS
# Phytoplankton - Mangrove forests          -1.6697 0.610 117  -2.738  0.0071 **
# Phytoplankton - Marshes                   -1.5775 0.521 117  -3.030  0.0030 **
# Phytoplankton - Grasslands                 1.9833 0.771 117   2.571  0.0114 *
# Phytoplankton - Terrestrial forests        1.8186 0.726 117   2.506  0.0136 *
# Macroalgal forests - Seagrass meadows      0.8147 0.388 117   2.102  0.0377 *
# Macroalgal forests - Mangrove forests      0.0954 0.478 117   0.199  0.8422 NS
# Macroalgal forests - Marshes               0.1875 0.357 117   0.525  0.6008 NS
# Macroalgal forests - Grasslands            3.7483 0.672 117   5.578  <.0001 ***
# Macroalgal forests - Terrestrial forests   3.5836 0.619 117   5.788  <.0001 ***
# Seagrass meadows - Mangrove forests       -0.7193 0.542 117  -1.328  0.1868 NS
# Seagrass meadows - Marshes                -0.6272 0.439 117  -1.428  0.1559 NS
# Seagrass meadows - Grasslands              2.9336 0.719 117   4.082  0.0001 ***
# Seagrass meadows - Terrestrial forests     2.7689 0.670 117   4.135  0.0001 ***
# Mangrove forests - Marshes                 0.0922 0.521 117   0.177  0.8598 NS
# Mangrove forests - Grasslands              3.6529 0.771 117   4.736  <.0001 ***
# Mangrove forests - Terrestrial forests     3.4883 0.726 117   4.807  <.0001 ***
# Marshes - Grasslands                       3.5607 0.703 117   5.065  <.0001 ***
# Marshes - Terrestrial forests              3.3961 0.653 117   5.203  <.0001 ***
# Grasslands - Terrestrial forests          -0.1647 0.866 117  -0.190  0.8495 NS
